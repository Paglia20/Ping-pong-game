...
SOURCE_FILES := main.c UART.c SRAM.c decoder.c ADC.c joystick.c slider.c SPI.c OLED.c cursor.c menu.c board.c MCP2515.c CAN.c
...
CC := avr-gcc
CFLAGS := -O2 -std=c11 -mmcu=$(TARGET_CPU) -ggdb
